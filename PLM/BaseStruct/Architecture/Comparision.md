...
[Beyond Standard LLMs - by Sebastian Raschka, PhD](https://magazine.sebastianraschka.com/p/beyond-standard-llms?utm_source=chatgpt.com)

（探讨了Attention, Linear Attention，扩散语言模型，世界模型，递归模型等）
