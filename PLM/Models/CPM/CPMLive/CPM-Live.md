...
这份部分可以参考相对位置编码[Self-Attention with Relative Position Representations](../../../BaseStruct/PositionEncoding/经典式相对位置编码/Self-Attention%20with%20Relative%20Position%20Representations.md)和T5的位置编码： [T5式](../../../BaseStruct/PositionEncoding/位置编码.md#T5式)
...
- f_si,sj(pi-pj)的矩阵absolute_position_bucket，参考t5的相对位置编码 [T5式](../../../BaseStruct/PositionEncoding/位置编码.md#T5式)
