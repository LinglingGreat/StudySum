...
- Application
  - Contest
    * [竞赛trick](Tool/Contest/竞赛trick.md)
- Basic Know
  ...
  - 树模型&集成学习
    ...
    - [Ada Boost](BasicKnow/树模型&集成学习/AdaBoost/AdaBoost.md)
    * [[集成学习]](BasicKnow/树模型&集成学习/[集成学习].md)
  - 特征工程
    * [数据分桶](BasicKnow/特征工程/数据分桶.md)
    * [特征工程概述](BasicKnow/特征工程/特征工程概述.md)
    * [特征选择](BasicKnow/特征工程/特征选择.md)
    * [LDA](BasicKnow/特征工程/LDA.md)
    * [PCA](BasicKnow/特征工程/PCA.md)
  - 线性模型
  ...
  - [优化算法](BasicKnow/优化算法/优化算法.md)
    - [拉格朗日对偶性](BasicKnow/优化算法/拉格朗日对偶性/拉格朗日对偶性.md)
    - 牛顿法
      * [牛顿法&拟牛顿法](BasicKnow/优化算法/牛顿法/牛顿法&拟牛顿法.md)
    - 梯度下降法
      * [梯度下降算法](BasicKnow/优化算法/梯度下降法/梯度下降算法.md)
    * [优化算法](BasicKnow/优化算法/优化算法.md)
  - 预处理
    * [[1-1]正则表达式](BasicKnow/预处理/[1-1]正则表达式.md)
    * [[1-2]文本预处理](BasicKnow/预处理/[1-2]文本预处理.md)
    * [[1-3]词性](BasicKnow/预处理/[1-3]词性.md)
    * [[1-4]语法分析](BasicKnow/预处理/[1-4]语法分析.md)
    * [[1-6]文本分类](BasicKnow/预处理/[1-6]文本分类.md)
  ...
  - Deep Learning
    - [反向传播](BasicKnow/反向传播/反向传播.md)
    - [梯度消失&梯度爆炸](BasicKnow/梯度消失&梯度爆炸/梯度消失&梯度爆炸.md)
    - [Batch Size](BasicKnow/BatchSize/BatchSize.md)
    * [1.DLbasis](BasicKnow/deep_learning/1.DLbasis.md)
    * [小概念](BasicKnow/others/deep_learning/小概念.md)
    * [MLstrategy](BasicKnow/others/MLstrategy.md)
    * [CNN](BasicKnow/CNN/CNN.md)
    * [RNN及其应用](BasicKnow/RNN/RNN及其应用.md)
    * [关于深度学习实践](BasicKnow/others/关于深度学习实践.md)
    * [神经网络概述](BasicKnow/others/神经网络概述.md)
    * [Batch Normalization](BasicKnow/BatchNorm/BatchNormalization.md)
    * [Program CNN](BasicKnow/CNN/program-CNN.md)
    * [Program D Lbasis](BasicKnow/others/program-DLbasis.md)
    * [Program DN Nimprove](BasicKnow/others/deep_learning/program-DNNimprove.md)
    * [Program Neural Style Transfer](BasicKnow/others/风格迁移.md)
    * [Summer DL](BasicKnow/others/deep_learning/summerDL.md)
  ...
  - Machine Learning
    * [[基础]概念](BasicKnow/others/[基础]概念.md)
    * [待整合](BasicKnow/others/待整合.md)
    * [交叉验证](BasicKnow/others/交叉验证.md)
    * [无监督学习](BasicKnow/others/无监督学习.md)
    * [优缺点](BasicKnow/others/优缺点.md)
    * [ML Yearning](BasicKnow/others/MLYearning.md)
    * [SVD](BasicKnow/others/SVD.md)
  - Statistics Math
    * [程序员的数学基础课](BasicKnow/statistics&math/程序员的数学基础课.md)
    * [数学基础](BasicKnow/statistics&math/数学基础.md)
    * [统计&高数](BasicKnow/statistics&math/统计&高数.md)
    * [统计题目](BasicKnow/statistics&math/统计题目.md)
    * [线性代数](BasicKnow/statistics&math/线性代数.md)
    * [组合数学](BasicKnow/statistics&math/组合数学.md)
...
- Course Note
  ...
  - 集训营
    * [任务说明](CourseNote/集训营/任务说明.md)
    * [算法实践1.1模型构建](CourseNote/集训营/算法实践1.1模型构建.md)
    * [算法实践1.2模型构建之集成模型](CourseNote/集训营/算法实践1.2模型构建之集成模型.md)
    * [算法实践2.1数据预处理](CourseNote/集训营/算法实践2.1数据预处理.md)
  - 李宏毅机器学习
    - 10DNN训练Tips
  ...
  - [Cs 224 N 2019](CourseNote/cs224n2019/README.md)
    ...
    * [Stanford NLP](CourseNote/cs224n2019/stanfordNLP.md)
  - [Deep Learning Book Goodfellow](CourseNote/Deep-Learning-Book-Goodfellow/README.md)
    - Books
      - [Deep Learning Book Chapter Summaries Master](CourseNote/Deep-Learning-Book-Goodfellow/books/Deep-Learning-Book-Chapter-Summaries-master/README.md)
    * [提纲](CourseNote/Deep-Learning-Book-Goodfellow/提纲.md)
    * [C 5](CourseNote/Deep-Learning-Book-Goodfellow/C5.md)
    * [C 6](CourseNote/Deep-Learning-Book-Goodfellow/C6.md)
  ...
  - [Lihang](CourseNote/lihang/readme.md)
  - NLP实战高手课
    * [极客时间_NLP实战高手课](CourseNote/NLP实战高手课/极客时间_NLP实战高手课.md)
  * [工具&资料](CourseNote/工具&资料.md)
  * [机器学习、深度学习面试知识点汇总](CourseNote/机器学习、深度学习面试知识点汇总.md)
  * [七月kaggle课程](CourseNote/七月kaggle课程.md)
  * [算法工程师](CourseNote/算法工程师.md)
  * [贪心科技机器学习必修知识点特训营](CourseNote/贪心科技机器学习必修知识点特训营.md)
  * [唐宇迪机器学习](CourseNote/唐宇迪机器学习.md)
  * [语言及工具](CourseNote/语言及工具.md)
  * [AI技术内参](CourseNote/AI技术内参.md)
  * [Suggestions](CourseNote/suggestions.md)
- Data Related
  - 数据质量
...
- NLG
  - [Dailogue](NLG/Dailogue/readme.md)
    ...
    - 业界分享
      ...
      - [微软小冰](NLG/Dailogue/业界分享/微软小冰/微软小冰.md)
      - [小布助手闲聊生成式算法](NLG/Dailogue/业界分享/小布助手闲聊生成式算法/小布助手闲聊生成式算法.md)
...
- Pre Training
  - 业界分享
    - 超大语言模型与语言理解_黄民烈
      * [超大语言模型与语言理解](PLM/业界分享/超大语言模型与语言理解_黄民烈/超大语言模型与语言理解.md)
    - 大模型的加速算法_腾讯微信
      * [大模型的加速算法](PLM/业界分享/大模型的加速算法_腾讯微信/大模型的加速算法.md)
    - [孟子轻量化预训练模型](PLM/业界分享/孟子轻量化预训练模型/孟子轻量化预训练模型.md)
    - [悟道文汇文图生成模型](PLM/业界分享/悟道文汇文图生成模型/悟道文汇文图生成模型.md)
    - [悟道文澜图文多模态大模型](PLM/业界分享/悟道文澜图文多模态大模型/悟道文澜图文多模态大模型.md)
    - 语义驱动可视化内容创造_微软
      * [语义驱动可视化内容创造](PLM/业界分享/语义驱动可视化内容创造_微软/语义驱动可视化内容创造.md)
  - Base
    - [Attention](PLM/BaseStruct/Attention/Attention.md)
    - Mask
      * [NLP中的Mask](PLM/BaseStruct/Mask/NLP中的Mask.md)
    - Position Encoding
      * [位置编码](PLM/BaseStruct/PositionEncoding/位置编码.md)
  - [BERT](PLM/BERT/BERT.md)
    - [ALBERT](PLM/BERT/ALBERT/ALBERT.md)
    - [Bert](Pre-training/BERT/bert/README.md)
      - Venv
        - Lib
          - Site Packages
            - idna-3.2.dist-info
              * [LICENSE](Pre-training/BERT/bert/venv/Lib/site-packages/idna-3.2.dist-info/LICENSE.md)
            - Markdown-3.3.4.dist-info
              * [LICENSE](Pre-training/BERT/bert/venv/Lib/site-packages/Markdown-3.3.4.dist-info/LICENSE.md)
            - Tensorflow
              - Include
                - External
                  - Libjpeg Turbo
                    * [LICENSE](Pre-training/BERT/bert/venv/Lib/site-packages/tensorflow/include/external/libjpeg_turbo/LICENSE.md)
                - Unsupported
                  - Eigen
                    - CXX 11
                      - Src
                        - [Tensor](Pre-training/BERT/bert/venv/Lib/site-packages/tensorflow/include/unsupported/Eigen/CXX11/src/Tensor/README.md)
            - Werkzeug
              - Debug
                - Shared
    ...
    - [Ro BER Ta](PLM/BERT/RoBERTa/RoBERTa.md)
    * [BERT](PLM/BERT/BERT.md)
    * [BERT面试问答](PLM/BERT/BERT面试问答.md)
    * [BERT源码解析](PLM/BERT/BERT源码解析.md)
    * [NSP BERT](PLM/BERT/NSP-BERT.md)
  - [BERT Flow](PLM/BERT/BERT-flow/BERT-flow.md)
  - BERT Zip
    - [Distilling The Knowledge In A Neural Network](PLM/BERTZip/Distilling_the_Knowledge_in_a_Neural_Network/Distilling_the_Knowledge_in_a_Neural_Network.md)
    - [TINYBERT](PLM/BERTZip/TINYBERT/TINYBERT.md)
    * [模型压缩](PLM/BERTZip/模型压缩.md)
  - [CPM](PLM/Models/CPM/CPM.md)
  - CPT
    * [兼顾理解和生成的中文预训练模型CPT](PLM/Models/CPT/兼顾理解和生成的中文预训练模型CPT.md)
  - [ELECTRA](PLM/Models/ELECTRA/ELECTRA.md)
  - [EL Mo](PLM/Models/ELMo/elmo.md)
  - [ERNIE系列语言模型](PLM/Models/ERNIE系列语言模型/ERNIE系列语言模型.md)
  - [GPT](PLM/Models/GPT/GPT.md)
  - [MBART](PLM/Models/MBART/MBART.md)
  - [NEZHA](PLM/Models/NEZHA/NEZHA.md)
  - NLG Sum
    * [simpread-预训练时代下的文本生成｜模型 & 技巧](Pre-training/NLGSum/simpread-预训练时代下的文本生成｜模型 & 技巧.md)
  - [Prompt](PLM/Prompt/Prompt.md)
    - 预训练模型的提示学习方法_刘知远
      * [预训练模型的提示学习方法](Pre-training/Prompt/预训练模型的提示学习方法_刘知远/预训练模型的提示学习方法.md)
  - [T 5](PLM/Models/T5/T5.md)
    - [Unified SKG](PLM/Models/T5/UnifiedSKG/UnifiedSKG.md)
    * [T 5](PLM/Models/T5/T5.md)
  - [Transformer](PLM/BaseStruct/Transformer/Transformer.md)
  - [Uni LM](PLM/Models/UniLM/UniLM.md)
  - [XL Net](PLM/Models/XLNet/XLNet.md)
  * [预训练语言模型](PLM/预训练语言模型.md)
  * [BERT变种](PLM/BERT/BERT变种.md)
- [Recsys](Recsys/README.md)
  ...
  - [召回](Recsys/召回/召回.md)
  - [Sparrow Rec Sys](Recsys/SparrowRecSys/README.md)
...
- Search
  ...
  * [查询关键字理解](Search/查询关键字理解.md)
  * [搜索排序](Search/搜索排序.md)
  * [BM 25](Search/BM25.md)
...
- Text Classification
  ...
  - [Text CNN](TextClassification/TextCNN/TextCNN.md)
  * [文本分类](TextClassification/文本分类.md)
- Text Matching
...
- Tool
  - [埋点](Tool/埋点/埋点.md)
  - [向量检索(Faiss等)](Tool/向量检索(Faiss等)/向量检索(Faiss等).md)
  - [Bigdata](Tool/Bigdata/README.md)
    * [大数据基础task1_创建虚拟机+熟悉linux](Tool/Bigdata/大数据基础task1_创建虚拟机+熟悉linux.md)
    * [任务链接](Tool/Bigdata/任务链接.md)
    * [Mr](Tool/Bigdata/mr.md)
    * [Task1参考答案](Tool/Bigdata/Task1参考答案.md)
    * [Task2参考答案](Tool/Bigdata/Task2参考答案.md)
    * [Task3参考答案](Tool/Bigdata/Task3参考答案.md)
    * [Task4参考答案](Tool/Bigdata/Task4参考答案.md)
    * [Task5参考答案](Tool/Bigdata/Task5参考答案.md)
  ...
  - Python
    - 可视化
      ...
      * [Matplotlib](Tool/python/可视化/Matplotlib.md)
      * [Tkinter](Tool/python/可视化/Tkinter.md)
      * [Turtle](Tool/python/可视化/Turtle.md)
    - 数据类型
      * [Datatype](Tool/python/数据类型/Datatype.md)
    - python爬虫
      - [Python Scraping Master](Tool/python/python爬虫/python-scraping-master/README.md)
        - [phantomjs-2.1.1-windows](Tool/python/python爬虫/python-scraping-master/phantomjs-2.1.1-windows/README.md)
      * [Regularexp](Tool/python/python爬虫/regularexp.md)
      * [Scrapying](Tool/python/python爬虫/scrapying.md)
    ...
    * [Fileprocess](Tool/python/Fileprocess.md)
    * [Format](Tool/python/Format.md)
    * [Functional Programming](Tool/python/Functional_programming.md)
    * [I Python](Tool/python/IPython.md)
    * [Magic](Tool/python/Magic.md)
    ...
    * [Time](Tool/python/Time.md)
  - [Pytorch](Tool/Pytorch/Pytorch.md)
    - [Dive Into DL Py Torch](Tool/Pytorch/Dive-into-DL-PyTorch/README.md)
      - [02 Softmax And Classification](Tool/Pytorch/Dive-into-DL-PyTorch/02_softmax_and_classification/README.md)
      - [03 Mlp](Tool/Pytorch/Dive-into-DL-PyTorch/03_mlp/README.md)
      - [04 Underfit Overfit](Tool/Pytorch/Dive-into-DL-PyTorch/04_underfit_overfit/README.md)
      - [05 Gradient Vanishing Exploding](Tool/Pytorch/Dive-into-DL-PyTorch/05_gradient_vanishing_exploding/README.md)
      - [06 Text Preprocess](Tool/Pytorch/Dive-into-DL-PyTorch/06_text_preprocess/README.md)
      - [07 Language Model](Tool/Pytorch/Dive-into-DL-PyTorch/07_language_model/README.md)
      - [08 Rnn Basics](Tool/Pytorch/Dive-into-DL-PyTorch/08_rnn_basics/README.md)
      - [09 Machine Translation](Tool/Pytorch/Dive-into-DL-PyTorch/09_machine_translation/README.md)
      - [10 Attention Seq 2 Seq](Tool/Pytorch/Dive-into-DL-PyTorch/10_attention_seq2seq/README.md)
      - [11 Transformer](Tool/Pytorch/Dive-into-DL-PyTorch/11_transformer/README.md)
      - [12 Cnn](Tool/Pytorch/Dive-into-DL-PyTorch/12_cnn/README.md)
      - [14 Batchnorm Resnet](Tool/Pytorch/Dive-into-DL-PyTorch/14_batchnorm_resnet/README.md)
      - [15 Convexoptim](Tool/Pytorch/Dive-into-DL-PyTorch/15_convexoptim/README.md)
      - [16 Gradientdescent](Tool/Pytorch/Dive-into-DL-PyTorch/16_gradientdescent/README.md)
      - [17 Optim Advance](Tool/Pytorch/Dive-into-DL-PyTorch/17_optim_advance/README.md)
  - [Spark](Tool/spark/spark.md)
    - [Pyspark](Tool/spark/pyspark/pyspark.md)
      * [pyspark之填充缺失的时间数据](Tool/spark/pyspark/pyspark之填充缺失的时间数据.md)
    * [Spark](Tool/spark/spark.md)
  - [SQL](Tool/SQL/sql.md)
    * [数据库](Tool/SQL/数据库.md)
    * [Hive Sql](Tool/SQL/hive&sql.md)
    * [MySQL实战45讲](Tool/SQL/MySQL实战45讲.md)
  - Tensor Flow
    * [TensorFlow入门](Tool/TensorFlow/TensorFlow入门.md)
* [Common](common.md)
* [NLP知识体系](NLP知识体系.md)
