...
- Basic Know
  - Base Model
    * [[1-1][语言模型]从N-gram模型讲起](BasicKnow/BaseModel/[1-1][语言模型]从N-gram模型讲起.md)
    * [[1-1]朴素贝叶斯与情感分类](BasicKnow/BaseModel/[1-1]朴素贝叶斯与情感分类.md)
    * [[1-2][语言模型]NNLM(神经网络语言模型)](BasicKnow/BaseModel/[1-2][语言模型]NNLM(神经网络语言模型).md)
    * [[1-3][语言模型]基于RNN的语言模型](BasicKnow/BaseModel/[1-3][语言模型]基于RNN的语言模型.md)
    * [[1-4][语言模型]用N-gram来做完形填空](BasicKnow/BaseModel/[1-4][语言模型]用N-gram来做完形填空.md)
    * [[1-5][语言模型]用KenLM来做完形填空](BasicKnow/BaseModel/[1-5][语言模型]用KenLM来做完形填空.md)
    * [BM 25](BasicKnow/BaseModel/BM25.md)
    * [LDA](BasicKnow/BaseModel/LDA.md)
    * [TFIDF](BasicKnow/BaseModel/TFIDF.md)
  - Deep Learning
    ...
    * [梯度下降算法](BasicKnow/deep_learning/梯度下降算法.md)
  ...
  - Machine Learning
    - [概率图模型](BasicKnow/machine_learning/概率图模型/概率图模型.md)
      * [最大熵模型](BasicKnow/machine_learning/概率图模型/最大熵模型.md)
    - 特征工程
      * [数据分桶](BasicKnow/machine_learning/特征工程/数据分桶.md)
      * [特征工程概述](BasicKnow/machine_learning/特征工程/特征工程概述.md)
      * [特征选择](BasicKnow/machine_learning/特征工程/特征选择.md)
      * [LDA](BasicKnow/machine_learning/特征工程/LDA.md)
      * [PCA](BasicKnow/machine_learning/特征工程/PCA.md)
    * [半监督学习](BasicKnow/machine_learning/半监督学习/半监督学习.md)
    * [朴素贝叶斯分类器](BasicKnow/贝叶斯/朴素贝叶斯分类器.md)
    * [聚类](BasicKnow/machine_learning/聚类/聚类.md)
    * [[机器学习]决策树](BasicKnow/machine_learning/[机器学习]决策树.md)
    * [K近邻](BasicKnow/k近邻法/K近邻.md)
    * [SVM支持向量机](BasicKnow/machine_learning/SVM/SVM支持向量机.md)
    * [[基础]概念](BasicKnow/machine_learning/[基础]概念.md)
    * [[集成学习]](BasicKnow/machine_learning/[集成学习].md)
    * [[集成学习]GBDT](BasicKnow/machine_learning/[集成学习]GBDT.md)
    * [[集成学习]XGBoost](BasicKnow/machine_learning/[集成学习]XGBoost.md)
    * [关联分析](BasicKnow/machine_learning/关联分析/关联分析.md)
    * [[线性模型]逻辑回归](BasicKnow/machine_learning/[线性模型]逻辑回归.md)
    * [[线性模型]线性回归](BasicKnow/machine_learning/[线性模型]线性回归.md)
  ...
  * [[1-1]正则表达式](BasicKnow/[1-1]正则表达式.md)
  * [[1-2]文本预处理](BasicKnow/[1-2]文本预处理.md)
  * [[1-3]词性](BasicKnow/[1-3]词性.md)
  * [[1-4]语法分析](BasicKnow/[1-4]语法分析.md)
  * [[1-6]文本分类](BasicKnow/[1-6]文本分类.md)
  * [[1-7]网络爬取](BasicKnow/[1-7]网络爬取.md)
  * [[2-1]神经网络](BasicKnow/[2-1]神经网络.md)
  * [【备用】正则表达式](BasicKnow/【备用】正则表达式.md)
  * [7.re模块](BasicKnow/7.re模块.md)
  * [绿色深度学习](BasicKnow/绿色深度学习.md)
  * [子表达式](BasicKnow/子表达式.md)
  * [Todo](BasicKnow/todo.md)
...
- Course Note
  ...
  - [Stanford NLP](CourseNote/stanfordNLP/stanfordNLP.md)
    * [Papernotes](CourseNote/stanfordNLP/papernotes.md)
...
- Search
  - 业界分享
    ...
    * [知乎搜索文本相关性](Search/业界分享/知乎搜索文本相关性.md)
  * [查询关键字理解](Search/查询关键字理解.md)
  * [搜索排序](Search/搜索排序.md)
  * [KDD21-淘宝搜索中语义向量检索技术](Search/KDD21-淘宝搜索中语义向量检索技术.md)
  * [query理解](Search/query理解.md)
- Statistics Math
  * [程序员的数学基础课](statistics&math/程序员的数学基础课.md)
  * [数学基础](statistics&math/数学基础.md)
  * [统计&高数](statistics&math/统计&高数.md)
  * [统计题目](statistics&math/统计题目.md)
  * [线性代数](statistics&math/线性代数.md)
  * [组合数学](statistics&math/组合数学.md)
  * [Discrete Choice Model](statistics&math/Discrete_Choice_Model.md)
  * [Nested Choice Model](statistics&math/Nested_Choice_Model.md)
