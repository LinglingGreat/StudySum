...
- [Python](Python/README.md)
  ...
  - Python
    - 可视化
      * [Interactivegraphics](Python/python/可视化/interactivegraphics.md)
      * [Matplotlib](Python/python/可视化/Matplotlib.md)
      * [Tkinter](Python/python/可视化/Tkinter.md)
      * [Turtle](Python/python/可视化/Turtle.md)
    - 数据类型
      * [Datatype](Python/python/数据类型/Datatype.md)
    - python爬虫
      - [Python Scraping Master](Python/python/python爬虫/python-scraping-master/README.md)
        - [phantomjs-2.1.1-windows](Python/python/python爬虫/python-scraping-master/phantomjs-2.1.1-windows/README.md)
      * [Regularexp](Python/python/python爬虫/regularexp.md)
      * [Scrapying](Python/python/python爬虫/scrapying.md)
      * [Selenium](Python/python/python爬虫/selenium.md)
    * [代码优化](Python/python/代码优化.md)
    * [一行代码](Python/python/一行代码.md)
    * [用python进行语言检测](Python/python/用python进行语言检测.md)
    * [Debug](Python/python/Debug.md)
    * [Exception](Python/python/Exception.md)
    * [Features Tricks](Python/python/Features & Tricks.md)
    * [Fileprocess](Python/python/Fileprocess.md)
    * [Format](Python/python/Format.md)
    * [Functional Programming](Python/python/Functional_programming.md)
    * [I Python](Python/python/IPython.md)
    * [Magic](Python/python/Magic.md)
    * [Math](Python/python/Math.md)
    * [Os](Python/python/os.md)
    * [Others](Python/python/others.md)
    * [Pandas](Python/python/Pandas.md)
    * [Python Datastructure](Python/python/python_datastructure.md)
    * [Python操作数据库](Python/python/Python操作数据库.md)
    * [Time](Python/python/Time.md)
  - [Pytorch](Python/Pytorch/Pytorch.md)
    - [Dive Into DL Py Torch](Python/Pytorch/Dive-into-DL-PyTorch/README.md)
      - [02 Softmax And Classification](Python/Pytorch/Dive-into-DL-PyTorch/02_softmax_and_classification/README.md)
      - [03 Mlp](Python/Pytorch/Dive-into-DL-PyTorch/03_mlp/README.md)
      - [04 Underfit Overfit](Python/Pytorch/Dive-into-DL-PyTorch/04_underfit_overfit/README.md)
      - [05 Gradient Vanishing Exploding](Python/Pytorch/Dive-into-DL-PyTorch/05_gradient_vanishing_exploding/README.md)
      - [06 Text Preprocess](Python/Pytorch/Dive-into-DL-PyTorch/06_text_preprocess/README.md)
      - [07 Language Model](Python/Pytorch/Dive-into-DL-PyTorch/07_language_model/README.md)
      - [08 Rnn Basics](Python/Pytorch/Dive-into-DL-PyTorch/08_rnn_basics/README.md)
      - [09 Machine Translation](Python/Pytorch/Dive-into-DL-PyTorch/09_machine_translation/README.md)
      - [10 Attention Seq 2 Seq](Python/Pytorch/Dive-into-DL-PyTorch/10_attention_seq2seq/README.md)
      - [11 Transformer](Python/Pytorch/Dive-into-DL-PyTorch/11_transformer/README.md)
      - [12 Cnn](Python/Pytorch/Dive-into-DL-PyTorch/12_cnn/README.md)
      - [14 Batchnorm Resnet](Python/Pytorch/Dive-into-DL-PyTorch/14_batchnorm_resnet/README.md)
      - [15 Convexoptim](Python/Pytorch/Dive-into-DL-PyTorch/15_convexoptim/README.md)
      - [16 Gradientdescent](Python/Pytorch/Dive-into-DL-PyTorch/16_gradientdescent/README.md)
      - [17 Optim Advance](Python/Pytorch/Dive-into-DL-PyTorch/17_optim_advance/README.md)
  - Tensor Flow
    * [TensorFlow入门](Python/TensorFlow/TensorFlow入门.md)
