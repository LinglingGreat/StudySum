        ...
        if year > 2018:
            ...
            for month in allmonth:
                ...
                Chrome_login.find_element_by_xpath(
                    "//select[@class='ui-datepicker-year']/option[@value='" + str(year) + "']").click()
                ...
                for day in allday:
                    ...
                    time.sleep(3)
                    try:
                        newfilename = 'shfe' + '-' + str(year) + '-' + str(int(month)+1) + '-' + str(day) + '.csv'
                        filepath = 'E:\\Mine\\国时资产\\futuredata\\shfe\\'
                ...
                #         "//select[@class='ui-datepicker-year']/option[@value='" + str(year) + "']").click()
                #     Chrome_login.find_element_by_xpath(
                #         "//select[@class='ui-datepicker-month']/option[@value='" + str(month) + "']").click()
                #     hasdata = Chrome_login.find_elements_by_xpath("//td[contains(@class, ' has-data')]//a")
                #
                # Chrome_login.find_element_by_xpath(
                #     "//select[@class='ui-datepicker-year']/option[@value='" + str(year) + "']").click()
...
if __name__ == '__main__':
    ...
    prefs = {'download.default_directory': 'E:\\Mine\\国时资产\\futuredata\\shfe\\'}
    options.add_experimental_option('prefs', prefs)
    Chrome_login = webdriver.Chrome(executable_path="E:\Mine\国时资产\chromedriver.exe",
